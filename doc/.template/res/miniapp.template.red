...
Article: [
    ...
    Source: [
        ...
        .text: {[http://miniapps.red/doc/e<%short-filename-without-extension%>/index.red](https://github.com/lepinekong/miniapps/blob/master/doc/<%short-filename-without-extension%>/index.red)
        }
        .Published-Urls: [
