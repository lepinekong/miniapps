...
quote-size: make pair! compose [(bigRect/1 - quote-position/1) (bigRect/2 - quote-position/2)] ; !!!!!!!! Bug -> should subtract 2 * quote-position
print (bigRect/1 - quote-position/1)
?? quote-size
